...
while (i < receita.length) {
  valTotal += receita[i].valor;
  i++;
}

console.log(`O valor total das vendas foi de R$${valTotal}`);
...
i = 0;
while (i < receita.length) {
  valGor += receita[i].gorjeta;
  i++;
}

console.log(
  `O valor total das vendas com gorgeta foi de R$${valTotal + valGor}`
);
...
console.log(`O número total de vendas abaixo de R$50,00 foi ${abaixoCinq}`);
...
// console.log(
//   `O valor total das vendas foi de R$${valTotal}\nO valor total das vendas com gorgeta foi de R$${
//     valTotal + valGor
//   }\nO número total de vendas abaixo de R$50,00 foi ${abaixoCinq}`
// );
